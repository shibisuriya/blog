...
draft: false
summary:
  'A dead simple tutorial on how to manage dotfiles meant for absolute
  beginners.'
...
Now that you know the very basics of managing dotfiles you can further explore,

- Managing dotfiles using GNU Stow

- Managing dotfiles using a 'bare Git repository'

- Nix (the package manager) or Ansible playbook to install programs on a new
  computer
