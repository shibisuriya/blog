...
If you own multiple computers, customizations done to a program installed on a
computer won't automatically propogate to other computers.

For example, changing your office computer's Z shell's prompt won't change the
prompt of the Z shell installed on your personal Desktop computer.

Syncing the customizations across multiple devices is the user's
responsibilty... The user has to manually compare the appropriate configuration
files present in multiple computers, carefully merge the differences, copy the
new version of the configuration files to all the devices and ensure that they
work... This method of keep the configuration files in sync across multiple
devices is time consuming, tedious and risky.
